	...
	class WS_Admin {
		...
		function stylesheet_config_page() {
			...
			if ( isset( $_POST['submitstyle'] ) ) {
				$stylesheet_data = sanitize_text_field( $_POST['fullstylesheet'] );
			...
			<div class="wrap">
				...
				<form name='wsadmingenform' action="<?php echo add_query_arg( 'page', 'weekly-schedule-stylesheet', admin_url( 'admin.php' ) ); ?>" method="post" id="ws-conf">
					...
					?>
					<textarea name='fullstylesheet' id='fancy-textarea' style='font-family:Courier' rows="30" cols="100"><?php echo esc_html( stripslashes( sanitize_text_field( $genoptions['fullstylesheet'] ) ) ); ?></textarea>
...
function ws_header_output() {
	...
	if ( $wsstylesheet ) {
		...
		echo esc_html( stripslashes( sanitize_text_field( $genoptions['fullstylesheet'] ) ) );
		echo "</style>\n";
	}
}
